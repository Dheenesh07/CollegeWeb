...
import AlumniCell from "./Components/ClubsandCells/Aluminicell/AluminiCell.jsx";
import PlacementCell from "./Components/ClubsandCells/PlacementCell/Placement.jsx";
import WomenEmpCell from "./Components/ClubsandCells/WomenEmp/WomenEmp.jsx";
function App() {
  return (
    <BrowserRouter>
      <Header/>
      ...
      <Routes>
        ...
        <Route path="/placements" element={<PlacementCell/>} /> <Route/>
        <Route path="/alumni" element={<AlumniCell/>} /> <Route/>
        <Route path="/woman-empowerment" element={<WomenEmpCell/>} /> <Route/>
